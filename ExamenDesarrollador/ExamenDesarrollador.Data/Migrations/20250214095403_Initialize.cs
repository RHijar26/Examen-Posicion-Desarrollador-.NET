    ...
    public partial class Initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientBuy", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientBuy_Client_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Client",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientBuy_Product_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateRegister = table.Column<DateTime>(type: "smalldatetime", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientBuy_ClientId",
                table: "ClientBuy",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientBuy_ProductId",
                table: "ClientBuy",
                column: "ProductId");
