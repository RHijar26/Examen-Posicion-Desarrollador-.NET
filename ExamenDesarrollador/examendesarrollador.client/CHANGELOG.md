...
- Create Angular project with ng: `ng new examendesarrollador.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`examendesarrollador.client.esproj`).
